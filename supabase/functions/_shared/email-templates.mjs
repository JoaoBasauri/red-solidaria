const types = {
  ...
  OFERTA_RECURSO: "Oferta de recursos",
  ALIADO: "Inscripción de aliado",
  VOLUNTARIO: "Inscripción de voluntario",
  PUNTO_ACOPIO: "Propuesta de punto de acopio",
};
const states = {
  RECIBIDA: "Recibida",
  EN_REVISION: "En revisión",
  OBSERVADA: "Requiere información",
  APROBADA: "Aprobada",
  RECHAZADA: "Rechazada",
  ATENDIDA: "Atendida",
  CERRADA: "Cerrada",
...
const fields = {
  ...
  necesidades_urgentes: "Necesidades urgentes",
  tipo_kit: "Tipo de kit",
  cantidad_solicitada: "Cantidad solicitada",
  poblacion_beneficiaria: "Personas beneficiarias",
  fecha_necesidad: "Fecha en que se necesita",
  condiciones_especiales: "Condiciones especiales",
  tipo_recurso: "Tipo de recurso",
  descripcion_recurso: "Descripción del recurso",
  cantidad: "Cantidad",
  unidad: "Unidad",
  disponibilidad_desde: "Disponible desde",
  disponibilidad_hasta: "Disponible hasta",
  tipo_aliado: "Tipo de aliado",
...
export function renderEmail(template, data = {}) {
  ...
  const rows = [
    ...
    ["Estado", states[data.estado] || "Recibida"],
    ["Asunto", data.asunto],
  ...
  const intro = received
    ? "Registramos tu solicitud en Red Solidaria. Este es el detalle que nos compartiste:"
